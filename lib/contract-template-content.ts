...
const PLACEHOLDERS: readonly ContractTemplatePlaceholder[] = [
  ...
  { token: "{{vehicle.color}}", label: "Vehicle color", sample: "Grey" },
  { token: "{{vehicle.fuelType}}", label: "Vehicle fuel type", sample: "Diesel" },
  { token: "{{vehicle.transmission}}", label: "Vehicle transmission", sample: "Automatic" },
  { token: "{{vehicle.mileage}}", label: "Vehicle mileage", sample: "42,500 km" },
  { token: "{{reservation.status}}", label: "Reservation status", sample: "Confirmed" },
  { token: "{{reservation.period}}", label: "Reservation period", sample: "27.04.2026 10:00 - 30.04.2026 10:00" },
  { token: "{{reservation.pickupLocation}}", label: "Pickup location", sample: "Airport" },
  { token: "{{reservation.returnLocation}}", label: "Return location", sample: "City centre" },
  ...
  { token: "{{reservation.extras}}", label: "Reservation extras", sample: "GPS, Child seat" },
